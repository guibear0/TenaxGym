...
export default function ICCPanel({ datosHistoricos, sexo }) {
  ...
  return (
    <motion.div
      ...
      layout // para animar suavemente cambios de tamaño
      className="mt-6 p-6 bg-gray-800/80 rounded-xl border border-gray-700/50 shadow text-center relative h-full"
    >
      ...
      <AnimatePresence>
        {mostrarInf && (
          ...
          >
            <p className="mb-3">
              El ICC se calcula dividiendo el perímetro de la cintura entre el perímetro de la cadera. Valores altos indican mayor riesgo cardiovascular según el sexo.
            </p>
            ...
            <table className="w-full text-center border border-gray-600 rounded-lg">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-2 py-1 border border-gray-600 text-green-400">Bajo</td>
                  <td className="px-2 py-1 border border-gray-600">&lt; 0.90</td>
                </tr>
                <tr>
                  <td className="px-2 py-1 border border-gray-600">0.80 – 0.90</td>
                  <td className="px-2 py-1 border border-gray-600 text-yellow-400">Moderado</td>
                  <td className="px-2 py-1 border border-gray-600">0.90 – 1.00</td>
                </tr>
                <tr>
                  <td className="px-2 py-1 border border-gray-600">&gt; 0.90</td>
                  <td className="px-2 py-1 border border-gray-600 text-orange-400">Alto</td>
